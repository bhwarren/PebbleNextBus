  ...
  switch (cell_index->section) {
    case 0:
      ...
      switch (cell_index->row) {
        case 0:
          // This is a basic menu item with a title and subtitle - ""
          menu_cell_basic_draw(ctx, cell_layer, "A Longview 33min", "Towards Family Practice", NULL);
          break;
				case 1:
					menu_cell_basic_draw(ctx, cell_layer, "N Longview 10min", "Towards Town Hall", NULL);
		  		break;
				case 2:
		  		menu_cell_basic_draw(ctx, cell_layer, "JFX Sitterson 2min", "Towards Jones Ferry Rd", NULL);
		  		break;
      }
